...
import java.applet.Applet;//一种不能单独运行但可嵌入在其他应用程序中的小程序。
import java.applet.AudioClip;//用于播放音频剪辑的简单抽象
import java.awt.Color;//颜色管理器
import java.awt.image.BufferedImage;//具有可访问图像数据缓冲区的
import java.io.IOException;
import java.net.URL;//代表一个统一资源定位符，它是指向互联网“资源”的指针

import javax.imageio.ImageIO;//简单编码和解码的静态便捷方法
